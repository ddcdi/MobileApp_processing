public class Sales {
  ...
  public void setup() {
    ...
    //screens[0] = new Sales(this, "매출 분석.png");        // First screen
    screens[0] = p.loadImage("매출 분석 (1).png");
    //screens[1] = new Sales(this, "매출 분석 (1).png");  // Second screen
    screens[1] = p.loadImage("매출 분석.png");
  }
  ...
  public void draw() {
    ...
    p.image(screens[currentScreen], 22, 1019); // Fit the image to the canvas
  }
}
